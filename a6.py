...
if __name__ == "__main__":
    ...
    print(b.classify("The solar eclipse is going to be beautiful and a once in a lifetime event!"))
    print(b.classify("The dance was incredible and I would do anything to see it again."))
    print(b.classify("No words, just awesomeness."))
    print("\nNegative String test")
    print(b.classify("The solar eclipse is going to be boring, why should we waste our time?"))
    print(b.classify("The movie was bland the whole way through and the actors did a horrible job."))
    print(b.classify("No plot, recycled backgrounds, and no background music. What kind of movie is this!?"))
    print(b.classify("All this hype for a dumspter fire of a movie? What a waste of time and money."))
    print("\nPositive rl reviews")
    print(b.classify("Dune: Part Two is up there with some of the greatest films of all time All the hype and great things I’ve heard about this film are all true! Denis Villeneuve Has cemented himself as one of the greatest storytellers and directors with this film; this puts him up there at the top of the food chain With the slow but progressive storytelling for the  character arcs as well as the meaning of the story and the idea of it all, it really captivates you and gets you involved until the end when it all comes together for the climax that has you needing more. There could be argument for multiple parts being the “climax” and each of those parts will single handily raise the hairs on your arm. From the incredible acting, perfect pacing, fantastic effects and overall story, Denis knew his exact vision for this film and executed it perfectly as he did not get lost in the middle of all the chaos of what’s going on or what could happen, it could not have been better. Dune Part One is a solid 8/10, as that was just a set up for This one, Dune Part Two is definitely up there, anything below a 9.5/10 would be disrespectful. It definitely solidifies itself as one the best made movies in history, although there are still perfect or close to perfect classic films that everyone can agree is a top movie of all time, whether it was too slow for you and you didn’t understand what was happening or it’s not your cup of tea, you can not discredit the making of this film that had no flaws and every second was exactly how it was supposed to be, it could make the argument for greatest film of all time, Denis has outdone himself and has made history, he deserves his flowers. This was close to if not being a perfect masterpiece that should be discussed by all movie lovers for years to come, if you disagree you must not truly love and appreciate the art of filmmaking. 9.8/10"))
    print(b.classify("This is honestly the best anime adaptation of anime into live action I've ever seen. This movie is great no lie. Even if it was a stand alone. Sure it could be palished a little bit more but it's not a bad movie at all"))
    print("\nNegative rl reviews")
    print(b.classify("I thought the first movie was excellent.  I was pleased the first movie attempted to get closer to the source material than the first Dune move from around 40 years ago did.  Dune Part One - good movie.  Watched it three times.  Was sad that there was a sequel....3 years later. Waited for this to come out.  Bought a ticket, Sunday matinee.  Theatre is about 40-45% ull, multiple screens showing it, no sell-outs reported.  I spent the entire time in the theatre without a potty break (which is rare for me) as I kept thinking, 'Any moment, this is gonna get good' and it never did.  It was....I honestly don't know what it was except some angsty teen-age stuff and a radical shift from character development that we saw in Part One to a somewhat-like-the-book Part Two. Looking back at Part One, I'm still attempting to figure out why it took until Part II for some of the characters to be introduced.   This one was a snooze-fest, best to wait until it shows up on Netflix or Amazon Prime.  Script feels like it was rushed....oh, and wait for the ending.  Don't expect a sequel as there's no way this movie brings in the cash they are hoping for based upon the poor reviews and low turn-out its had.  Not worth re-watching."))
    print(b.classify("If you have seen the anime, do not watch this movie by all means. The cast is just horrible with little resemblance to those in the anime, with Jay chow stiff and pretentious performance casting Takumi is a total disaster, which he has no acting skills and nothing that looks like Takumi at all. The role was highly objected in the beginning but someone insisted and convinced the company into casting him, which is a complete fail. The rest of the cast as well exaggeratedly overacted, with childish dialogues ending up like book reading. The only good thing I can think of is the nice scenery that are shot beautifully, however the lack of blood pumping intense racing scenes and original eurobeats which were the soul of the anime was completely lost. I don't mind the plot being cut short as a result of limited runtime for movie, but most of it's essence were lost due to bad acting and unconvincing casts presentations, which very much destroys the original story. It should have done a better casting with better actors who can act like the ones in anime. Highly disappointing and overrated."))
    pass
